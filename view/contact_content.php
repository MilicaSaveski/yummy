...
<!-- Contact Section Begin -->
    <section class="contact-section spad">
     ...
     <div id="feedbackPor"></div>

                    <form action="#" class="contact-form">
                        <h3>Ostavite komentar</h3>
                        <div class="row">
                            <div class="col-lg-6">
                                <input type="text" placeholder="Your name" id="namePor">
                            </div>
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-12">
                                <input type="text" placeholder="Subject" id="subjectPor">
                                <textarea placeholder="Comment" id="commentPor"></textarea>
                            </div>
                        </div>
                        <button type="button" id="porSend">Send Message</button>
                    </form>
    ...
    <!-- Map Section End -->
	<script type="text/javascript" src="js/porukeKorisnika.js"></script>